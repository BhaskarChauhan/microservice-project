...
@Tag(
        name = "CRUD REST APIs for Cards in ASPL bank",
        description = "CRUD REST APIs in ASPL bank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside ASPL bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
