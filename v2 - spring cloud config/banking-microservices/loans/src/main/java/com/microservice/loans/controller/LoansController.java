...
@Tag(
        name = "CRUD REST APIs for Loans in ASPL Bank",
        description = "CRUD REST APIs in ASPL Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside ASPL Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
